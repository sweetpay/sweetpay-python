...
"""The valid countries for Sweetpay."""
VALID_COUNTRIES = ["SE", "FI", "DE", "NO"]

"""The valid currencies for Sweetpay."""
VALID_CURRENCIES = ["SEK", "EUR", "USD"]

"""The valid redirect targets for Sweetpay."""
VALID_REDIRECT_TARGETS = ["CLOSE", "TOP", "PAGE"]

"""The valid languages for Sweetpay."""
VALID_LANGUAGES = ["SV", "EN", "DE", "FI", "NB"]

"""The valid payment methods for Sweetpay."""
VALID_PAYMENT_METHODS = ["INVOICE"]

"""The valid subscription intervals for Sweetpay."""
...
class CheckoutClient(object):
    ...
    def create_session(self, **params):
        ...
        try:
            ...
            # If the deserialization succeeded, build a Python
            # dictionary of it
